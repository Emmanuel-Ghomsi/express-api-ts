...
Use this link to confirm your account and log in</div>
                      ...
                      <tr>
                        <td class="sm-px-24"
                          style="--bg-opacity: 1; background-color: #ffffff;  border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;"
                           align="left">
                          <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">Cher ${name}</p>

                          <p style="margin: 0 0 24px;">
                          Bien vouloir utiliser le lien ci-dessous pour valider votre adresse mail.
                          </p>

                          <lable style="display: block; font-size: 24px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #000000; text-decoration: none;"><a href="${url}">${url}</a></lable>
                          ...
                          <p style="margin: 0 0 16px;">
                            Besoin d'aide ? Contactez-nous à l'adresse
                            <a href="mailto:${support}" class="hover-underline"
                              style="--text-opacity: 1; color: #7367f0;  text-decoration: none;">${support}</a>.
                          </p>
                          <p style="margin: 0 0 16px;">Merci, <br>L'équipe support</p>
                        </td>
                      </tr>
                      <tr>
  ...
  const text = `Bien vouloir utiliser le lien ci-dessous pour valider votre adresse mail.`;
